...
const EVENTS = [
  ...
  // --- Territory capture (weekly recurring, PHX / Server 168 EU, London time) — open-ended, not arc-tied ---
  {name:'Nujord — Territory Capture', variant:'', category:'TERRITORY', heroic:false, opsMin:1, opsMax:999, time:{h:15,m:0},
    occ:{kind:'weekly', dayOfWeek:5, start:'2026-07-20', end:'2027-12-31'}, note:'PHX conquest window · cost 1 currency.'},
  {name:'Duportas — Territory Capture', variant:'', category:'TERRITORY', heroic:false, opsMin:1, opsMax:999, time:{h:14,m:0},
    occ:{kind:'weekly', dayOfWeek:6, start:'2026-07-20', end:'2027-12-31'}, note:'PHX conquest window · cost 2 currency.'},
  ...
  {name:'Brellan — Territory Capture', variant:'', category:'TERRITORY', heroic:false, opsMin:1, opsMax:999, time:{h:19,m:0},
    occ:{kind:'weekly', dayOfWeek:0, start:'2026-07-20', end:'2027-12-31'}, note:'PHX conquest window · cost 3 currency.'},
  {name:'Bimasa — Territory Capture', variant:'', category:'TERRITORY', heroic:false, opsMin:1, opsMax:999, time:{h:17,m:0},
    occ:{kind:'weekly', dayOfWeek:2, start:'2026-07-20', end:'2027-12-31'}, note:'PHX conquest window · cost 2 currency.'}
];
